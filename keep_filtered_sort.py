...
def sort_only_GC_keep_filtered(min_GC, max_GC, output_base_name, file_name):
...
def sort_only_len_keep_filtered(min_len, output_base_name, file_name):
...
def sort_by_len_GC_keep_filtered(min_len, min_GC, max_GC,
