...
def sort_only_GC_trash_filtered(min_GC: int, max_GC: int,
...
def sort_only_len_trash_filtered(min_len: int,
                                 output_base_name: str, file_name: str):
...
def sort_by_len_GC_trash_filtered(min_len: int, min_GC: int, max_GC: int,
                                  output_base_name: str, file_name: str):
